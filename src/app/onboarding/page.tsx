...
function OnboardingContent() {
  ...
  let title = abbr && abbrToTitle[abbr as keyof typeof abbrToTitle] ? abbrToTitle[abbr as keyof typeof abbrToTitle] : undefined;
  if (!title && abbr === "BSA") {
    title = "CPA";
  }
  const greeting = title ? `Welcome Future ${title}!` : "Welcome!";

  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-50 to-cyan-100 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl px-8 py-10 flex flex-col items-center gap-6">
        ...
        <div className="w-full flex flex-col items-center gap-2">
          ...
          <p className="text-gray-500 text-center mb-4 text-base">
            Track your quiz results, save your progress, and access your dashboard from any device.
          </p>
            ...
            >
              <span style={{ display: "inline-flex", alignItems: "center", marginRight: 8 }}>
                <svg width="22" height="22" viewBox="0 0 48 48">
                  <g>
                    <path fill="#4285F4" d="M44.5 20H24v8.5h11.7C34.7 33.1 29.8 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c2.7 0 5.2.9 7.2 2.5l6.4-6.4C34.1 5.1 29.3 3 24 3 12.4 3 3 12.4 3 24s9.4 21 21 21c10.5 0 19.5-7.6 21-17.5.1-.7.1-1.3.1-2S44.6 20.7 44.5 20z"/>
                    <path fill="#34A853" d="M6.3 14.7l7 5.1C15.5 16.1 19.4 13 24 13c2.7 0 5.2.9 7.2 2.5l6.4-6.4C34.1 5.1 29.3 3 24 3c-7.2 0-13.4 3.8-17 9.7z"/>
                    <path fill="#FBBC05" d="M24 45c5.4 0 10.3-1.8 14.1-4.9l-6.5-5.3C29.7 36.1 27 37 24 37c-5.7 0-10.5-3.9-12.2-9.1l-7 5.4C7.7 41.2 15.3 45 24 45z"/>
                    <path fill="#EA4335" d="M44.5 20H24v8.5h11.7c-1.1 3.1-4.1 5.5-7.7 5.5-2.2 0-4.2-.7-5.7-2l-7 5.4C15.5 43.9 19.4 47 24 47c10.5 0 19.5-7.6 21-17.5.1-.7.1-1.3.1-2S44.6 20.7 44.5 20z"/>
                  </g>
                </svg>
              </span>
              Get Started with Google
              <div className="icon-1">
                <svg viewBox="0 0 26.3 65.33" style={{shapeRendering: 'geometricPrecision', textRendering: 'geometricPrecision', fillRule: 'evenodd', clipRule: 'evenodd'}} version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
                  <g id="Layer_x0020_1">
              ...
              <div className="icon-2">
                <svg viewBox="0 0 11.67 37.63" style={{shapeRendering: 'geometricPrecision', textRendering: 'geometricPrecision', fillRule: 'evenodd', clipRule: 'evenodd'}} version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
                  <g id="Layer_x0020_1">
        ...
        <button
          ...
          className="text-yellow-800 font-bold bg-yellow-100 border border-yellow-300 rounded-lg px-4 py-2 shadow hover:bg-yellow-200 hover:scale-105 transition-all duration-150 flex items-center gap-2"
        >
